...
INSERT INTO `tbl_test` (`uid`, `name`, `age`) VALUES
(2, 'jeff', '25');
...
('root', '[{\"db\":\"item_db\",\"table\":\"tblitems\"},{\"db\":\"db_test\",\"table\":\"tbl_test\"},{\"db\":\"testdb\",\"table\":\"tbl_wun\"}]');
...
('root', '2023-05-22 14:11:03', '{\"Console\\/Mode\":\"collapse\"}');
...
--
-- Table structure for table `tbl_wun`
--

CREATE TABLE `tbl_wun` (
  `uid` int(255) NOT NULL,
  `name` varchar(255) NOT NULL,
  `age` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `tbl_wun`
--

INSERT INTO `tbl_wun` (`uid`, `name`, `age`) VALUES
(1, 'jeff', '25'),
(2, 'jake', '28');
...
--
-- AUTO_INCREMENT for table `tbl_wun`
--
ALTER TABLE `tbl_wun`
  MODIFY `uid` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
